...
#ifndef ACLNN_AFD_ASYNC_COMBINE_RECV_H_
#define ACLNN_AFD_ASYNC_COMBINE_RECV_H_
...
/* function: aclnnAfdAsyncCombineRecvGetWorkspaceSize
 * parameters :
 * expandX : required
 * expertIds : required
...
/* function: aclnnAfdAsyncCombineRecv
 * parameters :
