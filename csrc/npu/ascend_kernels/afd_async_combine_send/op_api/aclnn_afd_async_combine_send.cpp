...
#include "aclnn_afd_async_combine_send.h"
#include "aclnnInner_afd_async_combine_send.h"
...
aclnnStatus aclnnAfdAsyncCombineSendGetWorkspaceSize(
...
{
    return aclnnInnerAfdAsyncCombineSendGetWorkspaceSize(expandX, commArgs, batchInfo,
...
aclnnStatus aclnnAfdAsyncCombineSend(
    void *workspace,
    uint64_t workspaceSize,
    aclOpExecutor *executor,
    aclrtStream stream)
{
    ...
    return aclnnInnerAfdAsyncCombineSend(workspace, workspaceSize, executor, stream);
}
