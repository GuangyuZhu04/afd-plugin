...
#ifndef ACLNN_AFD_ASYNC_DISPATCH_RECV_H_
#define ACLNN_AFD_ASYNC_DISPATCH_RECV_H_
...
/* function: aclnnAfdAsyncDispatchRecvGetWorkspaceSize
 * parameters :
 * x : required
 * commArgs : required
 * magic : required
...
/* function: aclnnAfdAsyncDispatchRecv
 * parameters :
